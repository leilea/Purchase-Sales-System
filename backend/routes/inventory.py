...
def serialize_inventory(i):
    return {
        ...
        'spec': i.product.spec if i.product else None,
        'material_grade': i.product.material_grade if i.product else None,
        'surface_treatment': i.product.surface_treatment if i.product else None,
